...
export const projects: Project[] = [
  {
    ...
    githubUrl: 'https://github.com/Mr-BiG1/linux-web/security-toolkit'
  },
  {
    ...
    githubUrl: 'https://github.com/Mr-BiG1/linux-web/incident-response'
  },
  {
    title: 'E-commerce Platform',
    description: 'Secure e-commerce platform with payment processing and inventory management.',
    technologies: ['React', 'Node.js', 'MongoDB', 'Stripe'],
    githubUrl: 'https://github.com/Mr-BiG1/linux-web/ecommerce'
  },
  {
    ...
    githubUrl: 'https://github.com/Mr-BiG1/linux-web/threat-dashboard'
  }
]; 