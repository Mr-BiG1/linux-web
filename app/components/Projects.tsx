...
//       >
//         <div className="bg-[#1a1b26] px-3 py-2 flex items-center justify-between border-b border-gray-800">
...
//         <div className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-4 font-mono">
